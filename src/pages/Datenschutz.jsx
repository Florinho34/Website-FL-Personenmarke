...
/**
 * Datenschutzerklärung – florian-lingner.ch
 * Stand: Juni 2026
 *
 * Erfüllt Schweizer revDSG (primär, da Sitz in CH) UND EU-DSGVO
 * (da in DACH geworben wird und EU-Besucher erreicht werden).
 *
 * Abgedeckte Dienste (alle live): Vercel (Hosting), Google Tag Manager,
 * Google Analytics 4, Microsoft Clarity, Meta Pixel, Google Fonts (CDN),
 * Kit/ConvertKit (Newsletter), Kontakt per E-Mail, Social-Media-Links.
 *
 * Drop-in für src/pages/Datenschutz.jsx (Route /datenschutz).
 *
 * HINWEIS (kein Anwalt): bestmöglicher Entwurf, im Zweifel kurz prüfen lassen.
 * Provider-Links bitte einmal gegenchecken (können sich ändern).
 */
    ...
    <div className="legal">
      ...
      <main className="legal__main">
        <header className="legal__head">
          ...
          <h1 className="legal__h1">Datenschutz­erklärung</h1>
          <p className="legal__lead">
            Diese Erklärung informiert dich darüber, welche personenbezogenen
            Daten beim Besuch dieser Website verarbeitet werden, zu welchem
            Zweck und auf welcher Grundlage. Sie richtet sich nach dem
            schweizerischen Datenschutzgesetz (revDSG) und – soweit anwendbar –
        ...
        <section className="legal__sec">
          ...
          <p>
            ...
            nach Treu und Glauben, Verhältnismässigkeit, Zweckbindung sowie –
            wo erforderlich – die Einwilligung).
          </p>
        </section>
        ...
        <section className="legal__sec">
          ...
          <p>
            ...
            einem sicheren, funktionierenden und bedarfsgerechten Angebot
            (Art. 6 Abs. 1 lit. f DSGVO). Im Geltungsbereich des revDSG stütze
            ich die Bearbeitung auf deine Einwilligung bzw. ein überwiegendes
        ...
        <section className="legal__sec">
          ...
          <p>
            ...
            Cookie-Einstellungen über den entsprechenden Link erneut aufrufst.
            Der Widerruf berührt die Rechtmässigkeit der bis dahin erfolgten
            Verarbeitung nicht.
          </p>
        ...
        <section className="legal__sec">
          ...
          <p>
            ...
            Google Analytics 4, einen Webanalysedienst der Google Ireland
            Limited (Gordon House, Barrow Street, Dublin 4, Irland). Google
            Analytics verwendet Cookies und ähnliche Technologien, um die Nutzung
            der Website auszuwerten (z. B. aufgerufene Seiten, ungefährer
            Standort auf Basis einer gekürzten IP-Adresse, Verweildauer,
            verwendetes Gerät). Die IP-Adresse wird von Google gekürzt
            verarbeitet; eine direkte Personenbeziehbarkeit wird dadurch
            erschwert.
          </p>
          <p>
        ...
        <section className="legal__sec">
          ...
          <p>
            Nach deiner Einwilligung in die Kategorie „Statistik" nutze ich
            Microsoft Clarity (Anbieter: Microsoft Ireland Operations Limited,
            One Microsoft Place, South County Business Park, Leopardstown,
            Dublin 18, Irland). Clarity erstellt anonymisierte Auswertungen des
            Nutzungsverhaltens, z. B. über Heatmaps und aggregierte
            Sitzungsaufzeichnungen (Mausbewegungen, Klicks, Scrollverhalten), um
            die Benutzerfreundlichkeit der Website zu verstehen und zu
            verbessern. Dabei können Nutzungs- und Gerätedaten verarbeitet
            werden.
          </p>
          <p>
            Rechtsgrundlage ist deine Einwilligung (Art. 6 Abs. 1 lit. a DSGVO).
        ...
        <section className="legal__sec">
          ...
          <p>
            ...
            Verhalten von Besucherinnen und Besuchern nachverfolgt werden,
            nachdem sie durch Anklicken einer Meta-Werbeanzeige (Facebook,
            Instagram) auf die Website weitergeleitet wurden. So lässt sich die
            Wirksamkeit von Werbeanzeigen auswerten und es lassen sich z. B.
            Zielgruppen für künftige Werbung bilden. Dabei können Daten an Meta
            übermittelt und mit deinem Meta-Konto verknüpft werden.
          </p>
          <p>
        ...
        <section className="legal__sec">
          ...
          <p>
            ...
            Dadurch erhält Google Kenntnis davon, dass über deine IP-Adresse
            diese Website aufgerufen wurde. Die Einbindung dient einer
            ansprechenden und konsistenten Darstellung meines Angebots.
          </p>
          <p>
        ...
        <section className="legal__sec">
          ...
          <p>
            ...
            bereitgestellt bzw. können Daten in die USA übermitteln
            (insbesondere Vercel, Google, Microsoft, Meta und Kit). In Ländern
            ausserhalb der EU/der Schweiz besteht unter Umständen kein mit dem
            europäischen bzw. schweizerischen Recht vergleichbares
            Datenschutzniveau.
          </p>
          <p>
            ...
            Standardvertragsklauseln der EU-Kommission, und – soweit
            einschlägig – auf deine ausdrückliche Einwilligung (Art. 49 Abs. 1
            lit. a DSGVO). Trotz dieser Massnahmen kann nicht vollständig
            ausgeschlossen werden, dass Behörden in den USA auf Daten zugreifen.
          </p>
        </section>
        ...
        <section className="legal__sec">
          ...
          <p>
            ...
            Daten nicht ohne deine Einwilligung weiter und lösche sie, sobald
        ...
        <section className="legal__sec">
          ...
          <p>
            ...
            Persönlichkeitstest an. Diese Subdomain ist ein eigenständiges
            Angebot mit eigener Datenverarbeitung (u. a. eigene Anmeldung über
            Kit sowie eigenes Tracking nach demselben Einwilligungsprinzip). Für
            die dortige Verarbeitung gilt die jeweils auf dieser Subdomain
            bereitgestellte Datenschutzinformation.
          </p>
        </section>
        ...
        <section className="legal__sec">
          ...
          <p>
            ...
            <a href="https://www.edoeb.admin.ch" target="_blank" rel="noopener noreferrer">
              edoeb.admin.ch
            </a>. Innerhalb der EU kannst du dich an die für dich zuständige
        ...
        <section className="legal__sec">
          ...
          <p>
            ...
            mit rechtlicher Wirkung dir gegenüber findet nicht statt.
          </p>
        </section>
        ...
        <section className="legal__sec">
          ...
          <p>
            Ich passe diese Datenschutzerklärung an, sobald Änderungen der von
            mir durchgeführten Datenverarbeitung dies erforderlich machen (z. B.
            bei der Einführung neuer Dienste). Es gilt jeweils die hier
...
.legal__h1 {
  ...
  font-size: clamp(2.3rem, 6.5vw, 3.7rem); margin: 0;
}
.legal__lead {
